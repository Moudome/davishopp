...
import { RiDribbbleFill, RiGithubFill, RiInstagramFill, RiLinkedinFill, RiTwitchFill, RiYoutubeFill } from 'react-icons/ri'
...
const SocialIcons = () => {
  return (
    <div className=' flex gap-6 pr-4'>
      ...
      <Link to={''} className='text-[#ff2e63] text-2xl hover:-translate-y-1 transition-all duration-500'><RiTwitchFill/></Link>
